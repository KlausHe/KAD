...
export  const Data_Currencies = new Map([
	// used in "iomlaid"
...
export const Data_NewsCountries = [
	"ae",
	"ar",
	"at",
	"au",
...
export const Data_Country_CodesIso3166 = new Map([
	// used in "News"
	["AF", "Afghanistan"],
	["AX", "Aland Islands"],
	["AL", "Albania"],
...
export const Data_Materials = {
	...
	matZustandList: [
		"Gusszustand (F)",
		"geschmidet (H112)",
		"kontrollierte Abkühlung nach dem Guss und kaltausgelagert (T1)",
		"kontrollierte Abkühlung nach dem Guss und warmausgelagert (T5)",
		"lösungsgeglüht und kaltausgelagert (T4)",
		"lösungsgeglüht und nicht vollständig warmausgelagert (T64)",
		"lösungsgeglüht und vollständig warmausgelagert (T6)",
	],
	Materials: {
		S185: {
			matGroup: "Stahl",
	...
	data: {
		...
		Doktorgrad: {
			...
			"Dr.rer.medic. (rerum medicinalium)":
				"Doktor der theoretischen Medizin, Medizinwissenschaften, Biomedizin, Medizintechnologie, medizinischen Biometrie und Bioinformatik, Gesundheitswissenschaften",
