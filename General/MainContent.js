...
export const rawContentGrid = {
  ...
  cl_Sudoku: {
    ...
    maingrid: {
      areas: [
        ...
        ["cl_SudokuCanvas", "cl_SudokuValidateHint"],
        ["cl_SudokuCanvas", "cl_SudokuAuto"],
  ...
  cl_Expansion: {
    ...
    maingrid: {
      areas: [
        ...
        ["cl_ExpansionCompare", "cl_ExpansionCompare", "cl_ExpansionCompare"],
        ["cl_ExpansionCBDifference", "cl_ExpansionCBDifference", "cl_ExpansionCBDifference"],
        ["cl_ExpansionCBCoefficient", "cl_ExpansionCBCoefficient", "cl_ExpansionCBCoefficient"],
    ...
    subgrid: [
      ...
      ["cl_ExpansionCompare", "center"],
      ["cl_ExpansionCBDifference", "center"],
      ["cl_ExpansionCBCoefficient", "center"],
  ...
  cl_Geometrie: {
    ...
    maingrid: {
      areas: [
        ["cl_GeometrieElement_0", "cl_GeometrieTable"],
        ["cl_GeometrieElement_1", "cl_GeometrieTable"],
        ["cl_GeometrieElement_2", "cl_GeometrieTable"],
        ["cl_GeometrieElement_3", "cl_GeometrieTable"],
        ["cl_GeometrieElement_4", "cl_GeometrieTable"],
        ["cl_GeometrieElement_5", "cl_GeometrieTable"],
        ["cl_GeometrieElement_6", "cl_GeometrieTable"],
        ["cl_GeometrieElement_7", "cl_GeometrieTable"],
        ["cl_GeometrieOptions", "cl_GeometrieCanvas"],
      ],
      rows: [1, 1, 1, 1, 1, 1, 1, 0],
    },
    subgrid: [
      ["cl_GeometrieElement_0", "center"],
      ["cl_GeometrieElement_1", "center"],
      ["cl_GeometrieElement_2", "center"],
      ["cl_GeometrieElement_3", "center"],
      ["cl_GeometrieElement_4", "center"],
      ["cl_GeometrieElement_5", "center"],
      ["cl_GeometrieElement_6", "center"],
      ["cl_GeometrieElement_7", "center"],
  ...
  cl_Kolid: {
    ...
    maingrid: {
      areas: [
        ...
        ["cl_KolidTableLength", "cl_KolidTableLength"],
        ["cl_KolidTableTolerances", "cl_KolidTableTolerances"],
      ],
      rows: [0, 1, 1, 1, 1, 2, 0, 0],
    },
    subgrid: [
      ["cl_KolidImg", "center"],
  ...
  cl_Niska: {
    ...
    maingrid: {
      areas: [
        ...
        // ["cl_NiskaPartingLineA", "cl_NiskaPartingLineB"],
  ...
  cl_Pormula: {
    ...
    maingrid: {
      areas: [
        ["cl_PormulaAddInputs", ".", "cl_PormulaOrder", "cl_PormulaOrder"],
        ["cl_PormulaInputs1", "cl_PormulaTypeSelectLinear", "cl_PormulaPrecision", "cl_PormulaPrecision"],
        ["cl_PormulaInputs2", "cl_PormulaTypeSelectExponential", "cl_PormulaAccuracy", "cl_PormulaAccuracy"],
        ["cl_PormulaInputs3", "cl_PormulaTypeSelectLogarithmus", "cl_PormulaLblResult", "cl_PormulaLblResult"],
        ["cl_PormulaInputs4", "cl_PormulaTypeSelectPotenz", "cl_PormulaLblResult", "cl_PormulaLblResult"],
        ["cl_PormulaInputs5", "cl_PormulaBestFit", "cl_PormulaPointResults", "cl_PormulaPointResults"],
        ["cl_PormulaInputs6", "cl_PormulaTypeSelectPolynom", "cl_PormulaPointEntryA", "cl_PormulaPointResultA"],
        ["cl_PormulaInputs7", "cl_PormulaPolyFit", "cl_PormulaPointEntryB", "cl_PormulaPointResultB"],
        ["cl_PormulaInputs8", "cl_PormulaInfo", "cl_PormulaPointEntryC", "cl_PormulaPointResultC"],
        ["cl_PormulaCanvas", "cl_PormulaCanvas", "cl_PormulaCanvas", "cl_PormulaCanvas"],
      ],
      rows: [1, 1, 1, 1, 1, 1, 1, 1, 1, 0],
    },
    subgrid: [
      ["cl_PormulaAddInputs", "right"],
      ["cl_PormulaInputs1", "right"],
      ["cl_PormulaInputs2", "right"],
      ["cl_PormulaInputs3", "right"],
      ["cl_PormulaInputs4", "right"],
      ["cl_PormulaInputs5", "right"],
      ["cl_PormulaInputs6", "right"],
      ["cl_PormulaInputs7", "right"],
      ["cl_PormulaInputs8", "right"],
      ["cl_PormulaInfo", "center"],
      ["cl_PormulaTypeSelectLinear", "right"],
      ["cl_PormulaTypeSelectExponential", "right"],
      ["cl_PormulaTypeSelectLogarithmus", "right"],
      ["cl_PormulaTypeSelectPotenz", "right"],
      ["cl_PormulaTypeSelectPolynom", "right"],
      ["cl_PormulaPolyFit", "right"],
      ["cl_PormulaBestFit", "right"],
      ...
      ["cl_PormulaPointEntryA", "right"],
      ["cl_PormulaPointEntryB", "right"],
      ["cl_PormulaPointEntryC", "right"],
      ["cl_PormulaPointResultA", "left"],
      ["cl_PormulaPointResultB", "left"],
      ["cl_PormulaPointResultC", "left"],
  ...
  cl_Thiontu: {
    ...
    subgrid: [
      ["cl_ThiontuInputArea", "center"],
      ["cl_ThiontuOutputArea", "center"],
